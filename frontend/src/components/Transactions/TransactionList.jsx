...
const FilterSection = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    // ...prev: This is the spread operator, which copies the existing state (filters object) into a new object.
    // it means when you update all the previous state is not lost.
